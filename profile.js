    ...
    function open_side() {
        ...
        document.getElementById("containerp").style.marginLeft = "25%";
        document.getElementById("containerp").style.width = "75%";
...
function close_side() {
    ...
    document.getElementById("containerp").style.marginLeft = "0%";
    document.getElementById("containerp").style.width = "100%";
